...
const TasksPage = () => {
    ...
    setTasks([
      {
        ...
        category: 'Generelt',
        description:
          'Dette er en eksempeloppgave for å demonstrere oppgavesystemet. Her står det diverse ' +
  ...
  return (
    <div className="flex justify-center min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      {selected && (
        <TaskModal task={selected} onClose={() => setSelected(null)} currentUser={currentUser} />
      )}
    </div>
  );
};
