...
vi.mock('../../components/regi/WorkManager/WorkApprovalList.tsx', () => ({
  default: () => <div data-testid="approval-list">Approval list</div>,
}));

vi.mock('../../components/regi/WorkManager/GrantRegiForm', () => ({
  default: () => <div data-testid="grant-regi-form">Grant regi form</div>,
}));

vi.mock('../../components/regi/WorkManager/Registatus', () => ({
